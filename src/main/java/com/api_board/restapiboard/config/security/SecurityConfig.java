...
import com.api_board.restapiboard.config.security.guard.CustomAccessDeniedHandler;
import com.api_board.restapiboard.config.security.guard.CustomAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().mvcMatchers("/exception/**", "/swagger-ui/**",
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .formLogin().disable()
                .csrf().disable()
                .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)//세션유지 x
                .and()
                .authorizeRequests()
